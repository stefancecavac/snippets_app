...
export const SnippetCard = ({ snippet }: SnippetCardProps) => {
  ...
  return (
    <>
      <div className="group relative overflow-hidden   rounded-lg border border-base-200 bg-base-100 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-base-300">
        <div className="flex flex-col pt-3  ">
          ...
          <div onClick={() => openModal()} className="group/showCode hover:cursor-pointer">
            ...
            <div className="flex flex-col  relative  px-3">
              <div className=" top-0 right-0 left-0 bottom-0 bg-base-100 opacity-0 transition-all flex items-center justify-center group-hover/showCode:opacity-80 absolute">
                <p className="p-1 rounded-full border border-base-200 shadow-sm text-primary ">Show code</p>
              </div>
